...
try:
    f = open("newton-leibniz_baseline_predictions_combined/7day_prediction_combined.csv", "w+")
...
for date in date_generated:
    try:
        ...
        data = pd.read_csv('newton-leibniz_baseline_predictions/7day_prediction_'+date.strftime("%Y-%m-%d")+'.csv')
        ...
        print("Error processing day"+'newton-leibniz_baseline_predictions/7day_prediction_'+date.strftime("%Y-%m-%d")+'.csv')
        print("Unexpected error:", sys.exc_info()[0])

        
f.close()
print("Finished written to "+ "newton-leibniz_baseline_predictions_combined/7day_prediction_combined.csv")
